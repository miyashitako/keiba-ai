...
__version__ = "1.4-jra_recalibration_v2_conservative_half_step"
...
RECENT_FORM_PENALTY = [
    (8.0, 4.6),   # 加重平均着順 ≥ 8.0 → +4.6ポイント（旧+3.9）
    (6.0, 2.4),   # ≥ 6.0 → +2.4（旧+2.0）
    (4.5, 0.8),   # ≥ 4.5 → +0.8（旧+0.7）
]
...
JRA_DIST_GOOD_FINISH_BONUS = {1: 4.0, 2: 3.6, 3: 2.9}
