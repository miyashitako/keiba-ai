...
__version__ = "1.6-jra_recalibration_v4_out_of_sample_check"
...
# 引き上げる。
RECENT_FORM_PENALTY = [
    (8.0, 6.0),   # 加重平均着順 ≥ 8.0 → +6.0ポイント（旧+5.0）
    (6.0, 3.1),   # ≥ 6.0 → +3.1（旧+2.6）
    (4.5, 1.1),   # ≥ 4.5 → +1.1（旧+0.9）
]
...
# 引き上げる。
JRA_DIST_GOOD_FINISH_BONUS = {1: 4.8, 2: 4.6, 3: 4.1}
