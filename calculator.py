...
__version__ = "1.5-jra_recalibration_v3_conservative_half_step"
...
RECENT_FORM_PENALTY = [
    (8.0, 5.0),   # 加重平均着順 ≥ 8.0 → +5.0ポイント（旧+4.6）
    (6.0, 2.6),   # ≥ 6.0 → +2.6（旧+2.4）
    (4.5, 0.9),   # ≥ 4.5 → +0.9（旧+0.8）
]
...
JRA_DIST_GOOD_FINISH_BONUS = {1: 4.6, 2: 4.2, 3: 3.4}
